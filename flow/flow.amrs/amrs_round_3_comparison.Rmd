...
acc_axsDiffFilt.prcs <- stats.data %>%
  ...
  dplyr::mutate(setting = ifelse(test = sensor == "soniAmrs02" & test_date %in% seq.Date(from = run_2_duration_date[1], to = run_2_duration_date[2], by = "1 day"), yes = "01.04.05", no = NA)) %>% 
