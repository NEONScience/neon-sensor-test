...
#   Kevin Styers (2020-09-22)
#     Changed location of sink() to "NUL:" for windows. If I use this for more than just AMRS will have to have an OS check and then run if/else if
##############################################################################################
